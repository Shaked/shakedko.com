---
layout: post
title: "Job Hunting, Business and Deployment System #1"
date: 2016-03-25 01:13:00 -0500
categories: deployment system
...
After living in Mexico, traveling in the United States of America and of course, visiting home while freelancing for [CNature](http://www.cnature.co.il "CNature") remotely during that time period, I decided to look for a new challenge. I knew that this challenge has to be interesting and different, so I looked for a few key topics:
...
Focusing on the business helps a lot. It does not mean that you have to understand everything from day 1, it just means that the business is your real mission; while coding, emailing or talking to people is just a tool that helps you achieve a greater goal than you are used to. That is why I believe that even if you are not going to be part of management, [you should still ask questions](https://www.linkedin.com/pulse/successful-candidates-do-ask-questions-ted-jansen?trk=prof-post "Successful Candidates Do Ask These Questions"). Obviously, you should do your research before, try to get the right information about the company, it's employees, founders, investors and anything else that can help you in achieving this goal.
